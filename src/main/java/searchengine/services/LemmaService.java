...
public class LemmaService {
    ...
    public ResponseEntity<?> IndexOnePage(String path){
        ...
        String urlHead = path.replaceAll(dbConnection.getUrlPatternTail(),"");
        String urlTail = path.replaceAll(dbConnection.getUrlPatternHead(),"");
        ...
        if (!sites.isEmpty()) {
            ...
            try {
                ...
                return dbConnection.throwException();
            }

                indexRepository.deleteByPageId(pageId);
                pageRepository.deleteById(pageId);

            statusCode = dbConnection.statusCode(path);
            Page page = new Page();
